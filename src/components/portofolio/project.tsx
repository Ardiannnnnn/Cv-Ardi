...
import type { PortfolioProject } from "@/types/locale";
...
const ProjectIcons = {
  web: (
    <svg
      className="w-10 h-10 md:w-12 md:h-12 text-text-secondary"
      fill="currentColor"
      viewBox="0 0 24 24"
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 px-0 md:px-4">
        ...
        >
          <h2 className="text-xl md:text-2xl font-bold text-text-primary leading-tight">
            <span className="text-gold italic">{t("projects.titleHighlight")}</span>{" "}
            {t("projects.title")}
          </h2>
        </div>
